...
module HMC_Module_Data_Static_Gridded
    ...
    use HMC_Module_Tools_IO,        only:   HMC_Tools_IO_Get1D_NC, HMC_Tools_IO_Get2d_NC, &
                                            HMC_Tools_IO_Get1d_ASCII, HMC_Tools_IO_GetArcGrid_ASCII, &
                                            check
...
contains
	...
	where(a2dVarDem.gt.0.0 .and. a2dVarBeta.le.0.0)
        ...
        !call debug_2dVar(dble(a2dVarCostF), iRows, iCols, 1)
        !call debug_2dVar(dble(a2dVarCf), iRows, iCols, 2)
        !call debug_2dVar(dble(a2dVarCostF1), iRows, iCols, 3)
        !call debug_2dVar(dble(a2dVarCostChFix), iRows, iCols, 4)
        !call debug_2dVar(dble(a2dVarC1), iRows, iCols, 5)
        !call debug_2dVar(dble(a2dVarF2), iRows, iCols, 6)
