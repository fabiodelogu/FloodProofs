...
contains
	...
	!------------------------------------------------------------------------------------------
        ...
        real(kind = 4)              :: dVarET, dVarAE, dVarETLake
        ...
        character(len = 20)                                 :: sVarAE, sVarET
        ...
        dVarAE = sum(a2dVarAE)/max(1,count(a2iVarMask.gt.0.0))
        dVarET = sum(a2dVarET)/max(1,count(a2iVarMask.gt.0.0))
        !------------------------------------------------------------------------------------------

        !------------------------------------------------------------------------------------------
        ! Updating lake and dam volume (using ET variable(s)
        ...
        !------------------------------------------------------------------------------------------
        ! ET cumulated
        a2dVarETCum = a2dVarETCum + a2dVarET
        !------------------------------------------------------------------------------------------
