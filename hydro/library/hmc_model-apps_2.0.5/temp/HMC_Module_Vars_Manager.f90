...
contains
    ...
    subroutine HMC_Vars_Allocate(iID, &
        ...
        allocate( oHMC_Vars(iID)%a2dUcDt            (iRows, iCols) )
    ...
    subroutine HMC_Vars_InitDefault(iID)
        ...
        oHMC_Vars(iID)%a2dVDam = 0.0        ! to store curve TV
        oHMC_Vars(iID)%a2dLDam = 0.0        ! to store curve TV
        ...
        oHMC_Vars(iID)%a2dUcAct = oHMC_Namelist(iID)%dUc
        oHMC_Vars(iID)%a2dUcDt = 0.0
