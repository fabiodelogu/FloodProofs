...
# Debug
#op_exec='-O2 -fimplicit-none  -Wall  -Wline-truncation  -Wcharacter-truncation  -Wsurprising  -Waliasing  -Wimplicit-interface  -Wunused-parameter  -fwhole-file  -fcheck=all  -std=f2008  -pedantic  -fbacktrace  -fall-intrinsics'
# Production
...
#-----------------------------------------------------------------------------------------
# Change executable(s) permission(s)
echo " Step 7 - Get profiling and memory test file(s) ... "
...
echo " Step 7 - Get profiling and memory test file(s) ... Done!"
echo ""
#-----------------------------------------------------------------------------------------
