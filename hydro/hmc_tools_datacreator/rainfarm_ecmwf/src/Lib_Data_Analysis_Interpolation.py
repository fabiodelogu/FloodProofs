...
def interpVarPointMLR(oDataGeo, oDataVar, oGeoXVar, oGeoYVar, oGeoZVar, 
    ...
    sPath='/home/fabio/Desktop/test2/'
    sFile= sPath+'interp-local.mat'
    io.savemat(sPath+ sFile,mdict={'w': a2dVarW})
    io.savemat(sPath+ sFile,mdict={'final': a2dVarFinal})
    io.savemat(sPath+ sFile,mdict={'data': a2dVarMap})
    io.savemat(sPath+ sFile,mdict={'residual': oDataInterp['Var_1']})
