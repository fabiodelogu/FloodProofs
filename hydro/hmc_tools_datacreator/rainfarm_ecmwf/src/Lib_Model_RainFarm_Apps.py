...
#     data = {}
#     data['arr'] = zf
#     sio.savemat(path+'zf.mat',data)
#     data = {}
#     data['arr'] = fs
#     sio.savemat(path+'fs.mat',data)
#     data = {}
#     data['arr'] = ft
#     sio.savemat(path+'ft.mat',data)
...
#     data = {}
#     data['arr'] = fx
#     sio.savemat(path+'fx.mat',data)
#     data = {}
#     data['arr'] = ft
#     sio.savemat(path+'ft_upd.mat',data)
...
def fitslope(fx, ii):
    ...
    s = np.zeros((nc,))
    for i in range(0, nc):
        ss = np.polyfit(np.log(ii), np.log(fx[ii-1,i]),1)
        s[i] = ss[0]
