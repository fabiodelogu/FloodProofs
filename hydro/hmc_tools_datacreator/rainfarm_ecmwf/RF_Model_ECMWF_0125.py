...
# python RF_Model_ECMWF_0125.py -settingfile settingfile.config -logfile logfile.config
# 
# Example:
# python RF_Model_ECMWF_0125.py
# -settingfile /home/fabio/Desktop//Project_RegioneMarche/hmc_tools_datacreator/rainfarm_ecmwf/config_algorithms/rf_model_ecmwf-0125_algorithm_local.config
# -logfile /home/fabio/Desktop/Project_RegioneMarche/hmc_tools_datacreator/rainfarm_ecmwf/config_logs/rf_model_ecmwf-0125_logging_local.config
#
# Version
...
def GetArgs():
    ...
    if oParserValue.sSettingFile:
        ...
        sSettingsFile = 'rf_model_ecmwf-0125_algorithm.config'
    
    if oParserValue.sLoggingFile:
        sLoggingFile = oParserValue.sLoggingFile
    else:
        sLoggingFile = 'rf_model_ecmwf-0125_logging.config'
...
if __name__ == "__main__":
    ...
    try:
        ...
        from Cpl_Apps_RF_Model_ECMWF_0125 import Cpl_Apps_RF_Model_ECMWF_0125
    ...
    try:
        ...
        #----------------------------------------------------------------------------
        # Dynamic Data
        oCpl_DynamicData = Cpl_Apps_RF_Model_ECMWF_0125(oDataTime=oDataTime, oDataGeo=oDataTerrain, oDataInfo=oDataInfo)
