...
# python RF_Model_LAMI_I7.py -settingfile settingfile.config -logfile logfile.config
# 
# Example:
# python RF_Model_LAMI_I7.py
# -settingfile /home/fabio/Desktop//Project_RegioneMarche/hmc_tools_datacreator/rainfarm_lami/config_algorithms/rf_model_lami-i7_algorithm_local.config
# -logfile /home/fabio/Desktop/Project_RegioneMarche/hmc_tools_datacreator/rainfarm_lami/config_logs/rf_model_lami-i7_logging_local.config
#
# Version
...
def GetArgs():
    ...
    if oParserValue.sSettingFile:
        ...
        sSettingsFile = 'rf_model_lami-i7_algorithm.config'
    
    if oParserValue.sLoggingFile:
        sLoggingFile = oParserValue.sLoggingFile
    else:
        sLoggingFile = 'rf_model_lami-i7_logging.config'
...
if __name__ == "__main__":
    ...
    #----------------------------------------------------------------------------
    # Start Program
    oLogStream.info('['+sProjectName+' Model - LAMI I7 (Version '+sProgramVersion+')]')
    ...
    oLogStream.info('[' + sProjectName + '] Model - Set LAMI I7 configuration ... ')
    ...
    try:
        ...
        from Cpl_Apps_RF_Model_LAMI_I7 import Cpl_Apps_RF_Model_LAMI_I7
        ...
        #----------------------------------------------------------------------------
        # End section
        oLogStream.info('[' + sProjectName + '] Model - Set LAMI I7 configuration ... OK')
        #----------------------------------------------------------------------------
        ...
        GetException('[' + sProjectName + '] Model - Set LAMI I7 configuration ... FAILED',1,1)
        #----------------------------------------------------------------------------
    ...
    oLogStream.info('[' + sProjectName + '] Model - Initialize LAMI I7  ... ')
    ...
    try:
        ...
        #----------------------------------------------------------------------------
        # End section
        oLogStream.info('[' + sProjectName + '] Model - Initialize LAMI I7 ... OK')
        #----------------------------------------------------------------------------
        ...
        #----------------------------------------------------------------------------
        # Algorithm exception(s)
        GetException('[' + sProjectName + '] Model - Initialize LAMI I7 ... FAILED',1,2)
        #----------------------------------------------------------------------------
    ...
    #----------------------------------------------------------------------------
    # Run DynamicData
    oLogStream.info('[' + sProjectName + '] Model - Execute LAMI I7 ... ')
    ...
    try:
        ...
        #----------------------------------------------------------------------------
        # Dynamic Data
        oCpl_DynamicData = Cpl_Apps_RF_Model_LAMI_I7(oDataTime=oDataTime, oDataGeo=oDataTerrain, oDataInfo=oDataInfo)
        ...
        #----------------------------------------------------------------------------
        # End section
        oLogStream.info('[' + sProjectName + '] Model - Execute LAMI I7 ... OK')
        #----------------------------------------------------------------------------
        ...
        #----------------------------------------------------------------------------
        # Algorithm exception(s)
        GetException('[' + sProjectName + '] Model - Execute LAMI I7 ... FAILED',1,3)
        #----------------------------------------------------------------------------
