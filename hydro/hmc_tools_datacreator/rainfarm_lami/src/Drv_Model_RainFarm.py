...
class Drv_Model_RainFarm(object):
    ...
    def builder_singlecore(self):
        ...
        for iE, iNEn in enumerate(a1iNEnsemble):
            ...
            # Debug
            #plt.figure(1)
            #plt.imshow(self.a3dDataXYT_IN[:,:,7], interpolation='none'); plt.colorbar();
            #plt.figure(2)
            #plt.imshow(self.a3dDataXYT_RF[:,:,7], interpolation='none'); plt.colorbar();
            #plt.figure(3)
            #plt.imshow(a3dModelXYT_RF[:,:,7], interpolation='none'); plt.colorbar();
            #plt.show()

            #import scipy.io as io
            #sPath='/hydro/hmc_tools_datacreator/rainfarm_lami/'
            #sPath = '/home/fabio/Desktop/test_lami-rf/'
            #sFile= 'server_data-rf.mat'
            #io.savemat(sPath+ sFile,mdict={'arr': self.a3dDataXYT_RF})
            #sFile= 'server_data-raw.mat'
            #io.savemat(sPath+ sFile,mdict={'arr': self.a3dDataXYT_IN})
            #--------------------------------------------------------------------------------
    ...
    def finalizer(a3dDataXYT_RF, a3dModelXYT_RF, a1oDataTime_RF,
        ...
        #import scipy.io as io
        #sPath='/hydro/hmc_tools_datacreator/rainfarm_lami/'
        #sFile= 'server_model-rf_raw.mat'
        #io.savemat(sPath+ sFile,mdict={'arr': a3dModelXYT_RF})
        #sFile= 'server_model-rf_interp.mat'
