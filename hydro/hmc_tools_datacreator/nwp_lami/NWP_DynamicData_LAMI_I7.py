...
# python NWP_DynamicData_LAMI_I7.py -settingfile settingfile.config -logfile logfile.config
# 
# Example:
# python NWP_DynamicData_LAMI_I7.py
# -settingfile /home/fabio/Desktop/EclipseKeplerProjects/Project_RegioneMarche/hmc_tools_datacreator/nwp_lami/config_algorithms/nwp_dynamicdata_lami-i7_algorithm_local.config
# -logfile /home/fabio/Desktop/EclipseKeplerProjects/Project_RegioneMarche/hmc_tools_datacreator/nwp_lami/config_logs/nwp_dynamicdata_lami-i7_logging_local.config
#
# Version
...
def GetArgs():
    ...
    if oParserValue.sSettingFile:
        ...
        sSettingsFile = 'nwp_dynamicdata_lami-i7_algorithm.config'
    
    if oParserValue.sLoggingFile:
        sLoggingFile = oParserValue.sLoggingFile
    else:
        sLoggingFile = 'nwp_dynamicdata_lami-i7_logging.config'
...
if __name__ == "__main__":
    ...
    #----------------------------------------------------------------------------
    # Start Program
    oLogStream.info('['+sProjectName+' DynamicData - LAMI I7 (Version '+sProgramVersion+')]')
    ...
    oLogStream.info('[' + sProjectName + '] DynamicData - Set LAMI I7 configuration ... ')
    ...
    try:
        ...
        from Cpl_Apps_NWP_DynamicData_LAMI_I7 import Cpl_Apps_NWP_DynamicData_LAMI_I7
        ...
        #----------------------------------------------------------------------------
        # End section
        oLogStream.info('[' + sProjectName + '] DynamicData - Set LAMI I7 configuration ... OK')
        #----------------------------------------------------------------------------
        ...
        GetException('[' + sProjectName + '] DynamicData - Set LAMI I7 configuration ... FAILED',1,1)
        #----------------------------------------------------------------------------
    ...
    oLogStream.info('[' + sProjectName + '] DynamicData - Initialize LAMI I7 ... ')
    ...
    try:
        ...
        #----------------------------------------------------------------------------
        # End section
        oLogStream.info('[' + sProjectName + '] DynamicData - Initialize LAMI I7 ... OK')
        #----------------------------------------------------------------------------
        ...
        #----------------------------------------------------------------------------
        # Algorithm exception(s)
        GetException('[' + sProjectName + '] DynamicData - Initialize LAMI I7 ... FAILED',1,2)
        #----------------------------------------------------------------------------
    ...
    #----------------------------------------------------------------------------
    # Run DynamicData
    oLogStream.info('[' + sProjectName + '] DynamicData - Execute LAMI I7 ... ')
    ...
    try:
        ...
        #----------------------------------------------------------------------------
        # Dynamic Data
        oCpl_DynamicData = Cpl_Apps_NWP_DynamicData_LAMI_I7(oDataTime=oDataTime, oDataGeo=oDataTerrain, oDataInfo=oDataInfo)
        ...
        #----------------------------------------------------------------------------
        # End section
        oLogStream.info('[' + sProjectName + '] DynamicData - Execute LAMI I7 ... OK')
        #----------------------------------------------------------------------------
        ...
        #----------------------------------------------------------------------------
        # Algorithm exception(s)
        GetException('[' + sProjectName + '] DynamicData - Execute LAMI I7 ... FAILED',1,3)
        #----------------------------------------------------------------------------
