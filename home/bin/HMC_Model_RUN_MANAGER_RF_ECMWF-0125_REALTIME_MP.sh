...
#-----------------------------------------------------------------------------------------
# Script settings
sScriptRun='HMC_Model_RUN_MANAGER_RF_ECMWF-0125_REALTIME'
...
declare -a a1sFileName=("nwp_dynamicdata_ecmwf-0125_lock_realtime_START.txt" "nwp_dynamicdata_ecmwf-0125_lock_realtime_END.txt" "rf_model_ecmwf-0125_lock_realtime_mp_START.txt" "rf_model_ecmwf-0125_lock_realtime_mp_END.txt")

# Lock file
sPathLock='/home/dpc-marche/lock/'
sFileLockStart='hmc_model_run-manager_lock_realtime_rf-ecmwf-0125_mp_START.txt'
sFileLockEnd='hmc_model_run-manager_lock_realtime_rf-ecmwf-0125_mp_END.txt'
#-----------------------------------------------------------------------------------------
...
sDataArchivePath='/hydro/archive/realtime_rf-ecmwf-0125'
...
if $bFileCheck == true; then
    ...
    if [ -f $sPathFileStart ] && [ -f $sPathFileEnd ]; then
        ...
        python /hydro/hmc_tools_runner/HMC_Model_RUN_Manager.py -settingfile /hydro/hmc_tools_runner/config_algorithms/hmc_model_run-manager_algorithm_server_realtime_rf-ecmwf-0125_mp01.config -logfile /hydro/hmc_tools_runner/config_logs/hmc_model_run-manager_logging_server_realtime_rf-ecmwf-0125_mp01.config -time $sTimeNow &
        iPID_RM_01=$!
        sleep 10
        ...
        python /hydro/hmc_tools_runner/HMC_Model_RUN_Manager.py -settingfile /hydro/hmc_tools_runner/config_algorithms/hmc_model_run-manager_algorithm_server_realtime_rf-ecmwf-0125_mp02.config -logfile /hydro/hmc_tools_runner/config_logs/hmc_model_run-manager_logging_server_realtime_rf-ecmwf-0125_mp02.config -time $sTimeNow &
        iPID_RM_02=$!
        sleep 10
        ...
        python /hydro/hmc_tools_runner/HMC_Model_RUN_Manager.py -settingfile /hydro/hmc_tools_runner/config_algorithms/hmc_model_run-manager_algorithm_server_realtime_rf-ecmwf-0125_mp03.config -logfile /hydro/hmc_tools_runner/config_logs/hmc_model_run-manager_logging_server_realtime_rf-ecmwf-0125_mp03.config -time $sTimeNow &
        iPID_RM_03=$!
        sleep 10
        ...
        python /hydro/hmc_tools_runner/HMC_Model_RUN_Manager.py -settingfile /hydro/hmc_tools_runner/config_algorithms/hmc_model_run-manager_algorithm_server_realtime_rf-ecmwf-0125_mp04.config -logfile /hydro/hmc_tools_runner/config_logs/hmc_model_run-manager_logging_server_realtime_rf-ecmwf-0125_mp04.config -time $sTimeNow &
        iPID_RM_04=$!
        sleep 10
        ...
        python /hydro/hmc_tools_runner/HMC_Model_RUN_Manager.py -settingfile /hydro/hmc_tools_runner/config_algorithms/hmc_model_run-manager_algorithm_server_realtime_rf-ecmwf-0125_mp05.config -logfile /hydro/hmc_tools_runner/config_logs/hmc_model_run-manager_logging_server_realtime_rf-ecmwf-0125_mp05.config -time $sTimeNow &
        iPID_RM_05=$!
        sleep 10
        ...
        python /hydro/hmc_tools_runner/HMC_Model_RUN_Manager.py -settingfile /hydro/hmc_tools_runner/config_algorithms/hmc_model_run-manager_algorithm_server_realtime_rf-ecmwf-0125_mp06.config -logfile /hydro/hmc_tools_runner/config_logs/hmc_model_run-manager_logging_server_realtime_rf-ecmwf-0125_mp06.config -time $sTimeNow &
        iPID_RM_06=$!
        sleep 10
        ...
        python /hydro/hmc_tools_runner/HMC_Model_RUN_Manager.py -settingfile /hydro/hmc_tools_runner/config_algorithms/hmc_model_run-manager_algorithm_server_realtime_rf-ecmwf-0125_mp07.config -logfile /hydro/hmc_tools_runner/config_logs/hmc_model_run-manager_logging_server_realtime_rf-ecmwf-0125_mp07.config -time $sTimeNow &
        iPID_RM_07=$!
        sleep 10
        ...
        python /hydro/hmc_tools_runner/HMC_Model_RUN_Manager.py -settingfile /hydro/hmc_tools_runner/config_algorithms/hmc_model_run-manager_algorithm_server_realtime_rf-ecmwf-0125_mp08.config -logfile /hydro/hmc_tools_runner/config_logs/hmc_model_run-manager_logging_server_realtime_rf-ecmwf-0125_mp08.config -time $sTimeNow &
        iPID_RM_08=$!
        sleep 10
        ...
        python /hydro/hmc_tools_runner/HMC_Model_RUN_Manager.py -settingfile /hydro/hmc_tools_runner/config_algorithms/hmc_model_run-manager_algorithm_server_realtime_rf-ecmwf-0125_mp09.config -logfile /hydro/hmc_tools_runner/config_logs/hmc_model_run-manager_logging_server_realtime_rf-ecmwf-0125_mp09.config -time $sTimeNow &
        iPID_RM_09=$!
        sleep 10
        ...
        python /hydro/hmc_tools_runner/HMC_Model_RUN_Manager.py -settingfile /hydro/hmc_tools_runner/config_algorithms/hmc_model_run-manager_algorithm_server_realtime_rf-ecmwf-0125_mp10.config -logfile /hydro/hmc_tools_runner/config_logs/hmc_model_run-manager_logging_server_realtime_rf-ecmwf-0125_mp10.config -time $sTimeNow &
        iPID_RM_10=$!
        sleep 10
        ...
        #python /hydro/hmc_tools_runner/HMC_Model_RUN_Manager.py -settingfile /hydro/hmc_tools_runner/config_algorithms/hmc_model_run-manager_algorithm_server_realtime_rf-ecmwf-0125_mp11.config -logfile /hydro/hmc_tools_runner/config_logs/hmc_model_run-manager_logging_server_realtime_rf-ecmwf-0125_mp11.config -time $sTimeNow &
        #iPID_RM_11=$!
        #sleep 10
        ...
        #python /hydro/hmc_tools_runner/HMC_Model_RUN_Manager.py -settingfile /hydro/hmc_tools_runner/config_algorithms/hmc_model_run-manager_algorithm_server_realtime_rf-ecmwf-0125_mp12.config -logfile /hydro/hmc_tools_runner/config_logs/hmc_model_run-manager_logging_server_realtime_rf-ecmwf-0125_mp12.config -time $sTimeNow &
        #iPID_RM_12=$!
        #sleep 10
        ...
        #python /hydro/hmc_tools_runner/HMC_Model_RUN_Manager.py -settingfile /hydro/hmc_tools_runner/config_algorithms/hmc_model_run-manager_algorithm_server_realtime_rf-ecmwf-0125_mp13.config -logfile /hydro/hmc_tools_runner/config_logs/hmc_model_run-manager_logging_server_realtime_rf-ecmwf-0125_mp13.config -time $sTimeNow &
        #iPID_RM_13=$!
        #sleep 10
        ...
        #python /hydro/hmc_tools_runner/HMC_Model_RUN_Manager.py -settingfile /hydro/hmc_tools_runner/config_algorithms/hmc_model_run-manager_algorithm_server_realtime_rf-ecmwf-0125_mp14.config -logfile /hydro/hmc_tools_runner/config_logs/hmc_model_run-manager_logging_server_realtime_rf-ecmwf-0125_mp14.config -time $sTimeNow &
        #iPID_RM_14=$!
        #sleep 10
        ...
        echo " ------> CHECK RUN MODEL JOB"# Exit unexpected mode
        jobs -l
        ...
        python /hydro/hmc_tools_postprocessing/HMC_PostProcessing_TIMESERIES_Dewetra.py -settingfile /hydro/hmc_tools_postprocessing/config_algorithms/hmc_postprocessing_timeseries-dewetra_algorithm_server_realtime_rf-ecmwf-0125_mp.config -logfile /hydro/hmc_tools_postprocessing/config_logs/hmc_postprocessing_timeseries-dewetra_logging_server_realtime_rf-ecmwf-0125_mp.config -time $sTimeNow
        iPID_PP=$!
