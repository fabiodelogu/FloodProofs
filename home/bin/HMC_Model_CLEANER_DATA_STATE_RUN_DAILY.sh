...
#-----------------------------------------------------------------------------------------
# Script settings
sScriptRun='HMC_Model_CLEANER_DATA_STATE_RUN_DAILY'
...
echo " ------> RUN: state_ws-db ... "
rm -r "/hydro/run/state_ws-db/data/"
mkdir "/hydro/run/state_ws-db/data/"
rm -r "/hydro/run/state_ws-db/exec/"
mkdir "/hydro/run/state_ws-db/exec/"
rm -r "/hydro/run/state_ws-db/cache/"
mkdir "/hydro/run/state_ws-db/cache/"
rm -r "/hydro/run/state_ws-db/temp/"
mkdir "/hydro/run/state_ws-db/temp/"
echo " ------> RUN: state_ws-db ... OK"
