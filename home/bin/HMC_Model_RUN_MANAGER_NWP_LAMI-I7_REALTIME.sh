...
#-----------------------------------------------------------------------------------------
# Script settings
sScriptRun='HMC_Model_RUN_MANAGER_NWP_LAMI-I7_REALTIME'
...
declare -a a1sFileName=("nwp_dynamicdata_lami-i7_lock_realtime_START.txt" "nwp_dynamicdata_lami-i7_lock_realtime_END.txt")

# Lock file
sPathLock='/home/dpc-marche/lock/'
sFileLockStart='hmc_model_run-manager_lock_realtime_nwp-lami-i7_START.txt'
sFileLockEnd='hmc_model_run-manager_lock_realtime_nwp-lami-i7_END.txt'
#-----------------------------------------------------------------------------------------
...
sDataArchivePath='/hydro/archive/realtime_nwp-lami-i7'

sDataDDSPath_Grid=''
sDataTypePath_Grid=''

sDataDDSPath_Point1='/share/series/deterministiclami'
sDataTypePath_Point1='/timeseries/section_q'

sDataDDSPath_Point2='/share/series/damsdeterministiclami'
...
if $bFileCheck == true; then
    ...
    if [ -f $sPathFileStart ] && [ -f $sPathFileEnd ]; then
        ...
        python /hydro/hmc_tools_runner/HMC_Model_RUN_Manager.py -settingfile /hydro/hmc_tools_runner/config_algorithms/hmc_model_run-manager_algorithm_server_realtime_nwp-lami-i7.config -logfile /hydro/hmc_tools_runner/config_logs/hmc_model_run-manager_logging_server_realtime_nwp-lami-i7.config -time $sTimeNow
        iPID_RM=$!
        ...
        python /hydro/hmc_tools_postprocessing/HMC_PostProcessing_TIMESERIES_Dewetra.py -settingfile /hydro/hmc_tools_postprocessing/config_algorithms/hmc_postprocessing_timeseries-dewetra_algorithm_server_realtime_nwp-lami-i7.config -logfile /hydro/hmc_tools_postprocessing/config_logs/hmc_postprocessing_timeseries-dewetra_logging_server_realtime_nwp-lami-i7.config -time $sTimeNow
        iPID_PP=$!
